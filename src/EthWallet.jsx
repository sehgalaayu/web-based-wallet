  ...
  return (
    <section>
      <div className="mb-2 flex items-center justify-between">
        <p className="label-caps">Ethereum Wallets</p>
        <button
          ...
          {wallets.map((wallet, index) => (
            ...
            >
              <div className="mb-3 flex items-center justify-between">
                <span className="rounded-full border border-[var(--border)] bg-[rgba(123,143,245,0.12)] px-2 py-0.5 text-[11px] text-[var(--blue)]">
                  ETH Account {index + 1}
                </span>
                <button
                  className="rounded-md border border-[var(--border)] p-1 text-[var(--text-2)] transition-all duration-150 hover:text-[var(--text-1)]"
                  onClick={() => copyAddressIconAction(wallet.address, index)}
                >
